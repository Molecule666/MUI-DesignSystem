...
import { IconlyLightoutlineMessage, MessageQuestionDarkSvg, MessageQuestionLightSvg } from "assets";
...
const KitView = () => {
    ...
    const fillColor =
        theme.palette.mode === "dark" ? <MessageQuestionDarkSvg /> : <MessageQuestionLightSvg />;
            ...
            <Grid container spacing={2} mt={3}>
                ...
                <Grid size={6} border={1} borderRadius={2} p={1}>
                    ...
                    <Box display={"flex"} justifyContent={"space-around"}>
                        ...
                        <Box>
                            <RadioButtonKit color="error" size="medium" label1="No" label2="Yes" />
                            <RadioButtonKit color="error" size="small" label1="No" label2="Yes" />
                        </Box>
                        <Box>
                            <RadioButtonKit
                                color="primary"
                                ...
                                label2="Yes"
                            />
                            <RadioButtonKit color="primary" size="small" label1="No" label2="Yes" />
                        </Box>
                    </Box>
                </Grid>
                <Grid size={6} border={1} borderRadius={2} p={1}>
